   ...
   className="h-[250px] w-[250px] max-sm:w-[150px] max-sm:h-[150px] "
      />
       ...
       I bring your web visions to life as a versatile  {`full-stack developer`}
         ...
         <button className="text-[black]  hover:text-[black]  hover:bg-[#763CAC] bg-[#B1C7FF]   flex justify-center  items-center
     max-w-[148px] w-[160px] h-[43px]  px-2 mb-6 pt-[10px]  pb-2 font-title max-sm:mt-[-15px]  rounded">project</button>
    </div>
  </div>
