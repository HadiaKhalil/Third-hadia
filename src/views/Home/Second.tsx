  ...
  return (
    <div>
      <div className="text-[white]">
        <div className="container grid  items-center lg:grid-cols-2 grid-cols-1  relative ">
          <div>
            <div className="">
            <div className=" absolute ml-16 mt-8 max-sm:mt-5">
                <Image
            ...
            <p className="  mb-12 mt-12 max-lg:text-[15px] max-sm:mt-4   max-w-[470px]">
